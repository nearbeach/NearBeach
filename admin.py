...
admin.site.register(kanban_board_group)
...
admin.site.register(opportunity_permission)
...
admin.site.register(quote_group)
admin.site.register(quote_permission)
admin.site.register(quote_product_and_service)
admin.site.register(quote_template)
admin.site.register(requirement)
admin.site.register(requirement_group)
admin.site.register(requirement_item)
admin.site.register(requirement_item_link)
admin.site.register(requirement_link)
admin.site.register(requirement_permission)
admin.site.register(quote_responsible_customer)
admin.site.register(stage)
admin.site.register(task_action)
admin.site.register(task_customer)
admin.site.register(task_group)
