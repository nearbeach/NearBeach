...
describe("Team Leader - Shakeout Organisation", () => {
  ...
  it("Team Leader will please in correct information into fields", () => {
    cy.get('#id_organisation_website').clear().type("https://nearbeach.org");
  ...
  it("The Team Leader will now modify the form - and submit", () => {
    cy.get('#id_organisation_name')
      .clear()
      .type("Example Organisation");

    cy.get('#id_organisation_website')
      .clear()
      .type("https://example.com");
    
    cy.get('#id_organisation_email')
      .clear()
  ...
  it("Team Leader appends data onto the attributes of the Organisation", () => {
    ...
    cy.get('#id_organisation_name')
      .should('have.value','Example Organisation EDIT');

    cy.get('#id_organisation_website')
      .should('have.value','https://example.com.edit');
    
    cy.get('#id_organisation_email')
      .should('have.value','contact@example.com.edit');
  })
  ...
  it("Team Leader will add a note to the organisation", () => {
    ...
    cy.get('#misc-modules > [data-v-ce8eeb0a=""] > .row > .col-md-12 > .btn').click();
    cy.wait(500);
    ...
    cy.get('#newNoteModal > .modal-dialog > .modal-content > .modal-footer > .btn-primary').click();
  ...
  it("Team Leader will create a new contact on the organisation information page", () => {
    ...
    cy.get('#addCustomerModal > .modal-dialog > .modal-content > .modal-footer > .btn-primary').click()
    cy.wait(1000);
