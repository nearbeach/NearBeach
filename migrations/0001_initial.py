# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-14 03:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission_set', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='groups', chained_model_field='groups', on_delete=django.db.models.deletion.CASCADE, to='NearBeach.group_permissions')),
