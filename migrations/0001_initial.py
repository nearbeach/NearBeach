# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-04 08:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='requirement_item_permissions',
            fields=[
                ('requirement_item_permissions_id', models.AutoField(primary_key=True, serialize=False)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.CharField(choices=[('TRUE', 'TRUE'), ('FALSE', 'FALSE')], default='FALSE', max_length=5)),
                ('change_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requirement_item_permissions_change_user', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='requirement_item_permissions',
            name='task_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='NearBeach.tasks'),
        ),
        migrations.AddField(
