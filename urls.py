...
re_path(r'^associated_tasks/(?P<project_id>[0-9]+)/', views.associated_tasks, name='associated_tasks'),
...
re_path(r'^customers_campus_information/(?P<customer_campus_id>[0-9]+)/(?P<customer_or_org>["CUST","CAMP"]+)',views.customers_campus_information, name="customers_campus_information"),
...
re_path(r'^dashboard/active_requirements', views.dashboard_active_requirements, name='dashboard_active_requirements'),
re_path(r'^dashboard/active_tasks', views.dashboard_active_tasks, name='dashboard_active_tasks'),
re_path(r'^dashboard/group_active_projects', views.dashboard_group_active_projects,name='dashboard_group_active_projects'),
re_path(r'^dashboard/group_active_tasks', views.dashboard_group_active_tasks,name='dashboard_group_active_tasks'),
...
re_path(r'^delete_campus_contact/(?P<customers_campus_id>[0-9]+)/(?P<cust_or_camp>["CUST","CAMP"]+)',views.delete_campus_contact, name='delete_campus_contact'),
...
re_path(r'^information_customer_documents_list/(?P<customer_id>[0-9]+)/(?P<organisations_id>[0-9]+)/$',views_customer_information.information_customer_documents_list,name='information_customer_documents_list'),
...
re_path(r'^information_project_customers/(?P<project_id>[0-9]+)/$', views_project_information.information_project_customers, name='information_project_customers'),
...
re_path(r'^information_task_customers/(?P<task_id>[0-9]+)/$', views_task_information.information_task_customers,name='information_task_customers'),
...
re_path(r'^new_customer/(?P<organisations_id>[0-9]+)/', views.new_customer, name='new_customer'),
...
re_path(r'^organisation_information/(?P<organisations_id>[0-9]+)/', views.organisation_information,name='organisation_information'),
...
re_path(r'^search_organisations', views.search_organisations, name='search_organisations'),
re_path(r'^search_projects_tasks', views.search_projects_tasks, name='search_projects_tasks'),
