...
urlpatterns = [
    ...
    # Dashboard
    path('dashboard/get/bug_list/',
         dashboard_views.get_bug_list, name='get_bug_list'),
    path('dashboard/get/my_objects/',
         dashboard_views.get_my_objects, name='get_my_objects'),
    path('dashboard/get/rfc_approvals/',
         dashboard_views.rfc_approvals, name='rfc_approvals'),
    path('dashboard/get/unassigned_objects/',
         dashboard_views.get_unassigned_objects, name='get_unassigned_objects'),
    path('dashboard/get/users_with_no_groups/',
         dashboard_views.users_with_no_groups, name='users_with_no_groups'),
    ...
    path('documentation/<destination>/<location_id>/upload/',
         document_views.document_upload, name='document_upload'),
    path('documentation/get/max_upload/',
         document_views.get_max_upload, name='document_get_max_upload'),

    # Groups
    path('group_information/<int:group_id>/',
         group_views.group_information, name='group_information'),
    path('group_information/<int:group_id>/save/',
         group_views.group_information_save, name='group_information_save'),
    path('group_information/check_group_name/',
         group_views.check_group_name, name='check_group_name'),

    # Kanban Columns
    path('kanban_column/<int:kanban_column_id>/edit/',
         kanban_column_views.edit_column, name='kanban_edit_column'),
    path('kanban_column/<int:kanban_board_id>/delete/',
         kanban_column_views.delete_column, name='kanban_delete_column'),
    path('kanban_column/<int:kanban_board_id>/new/',
         kanban_column_views.new_column, name='kanban_new_column'),
    path('kanban_column/<int:kanban_board_id>/resort/',
         kanban_column_views.resort_column, name='kanban_resort_column'),

    # Kanban Levels
    path('kanban_level/<int:kanban_level_id>/edit/',
         kanban_level_views.edit_level, name='kanban_edit_level'),
    path('kanban_level/<int:kanban_board_id>/delete/',
         kanban_level_views.delete_level, name='kanban_delete_level'),
    path('kanban_level/<int:kanban_board_id>/new/',
         kanban_level_views.new_level, name='kanban_new_level'),
    path('kanban_level/<int:kanban_board_id>/resort/',
         kanban_level_views.resort_level, name='kanban_resort_level'),

    # Kanban
    path('kanban_information/archive_kanban_cards/',
         kanban_views.archive_kanban_cards, name="archive_kanban_cards"),
    path('kanban_information/<int:kanban_board_id>/',
         kanban_views.kanban_information, name='kanban_information'),
    path('kanban_information/<int:kanban_board_id>/close_board/',
         kanban_views.kanban_close_board, name='kanban_close_board'),
    path('kanban_information/<int:kanban_board_id>/edit_board/',
         kanban_views.kanban_edit_board, name='kanban_edit_board'),
    ...
    path('kanban_information/<int:kanban_board_id>/new_card/',
         kanban_views.new_kanban_card, name='new_kanban_card'),
    path('kanban_information/<int:kanban_card_id>/move_card/',
         kanban_views.move_kanban_card, name='move_kanban_card'),
    path('kanban_information/check_kanban_board_name/', kanban_views.check_kanban_board_name,
         name='check_kanban_board_name'),
    path('kanban_information/update_card/',
         kanban_views.update_card, name='kanban_update_card'),
    ...
    # Private files
    path('private/<uuid:document_key>/',
         document_views.private_download_file, name='private_download_file'),

    # Profiles
    path('profile_information/', profile_views.profile_information,
         name='profile_information'),
    path('profile_information/update_data/',
         profile_views.update_data, name='profile_update_data'),

    # New Objects
    path('new_customer/', customer_views.new_customer, name='new_customer'),
    path('new_customer/save/', customer_views.new_customer_save,
         name='new_customer_save'),
    ...
    path('new_organisation/', organisation_views.new_organisation,
         name='new_organisation'),
    path('new_organisation/save/', organisation_views.new_organisation_save,
         name='new_organisation_save'),
    path('new_permission_set/', permission_set_views.new_permission_set,
         name='new_permission_set'),
    path('new_permission_set/save/', permission_set_views.new_permission_set_save,
         name='new_permission_set_save'),
    path('new_project/', project_views.new_project, name='new_project'),
    path('new_project/save/', project_views.new_project_save,
         name='new_project_save'),
    path('new_request_for_change/', request_for_change_views.new_request_for_change,
    ...
    path('new_requirement/', requirement_views.new_requirement,
         name='new_requirement'),
    path('new_requirement/save/', requirement_views.new_requirement_save,
    ...
    # Object Data
    path('object_data/admin_add_user/',
         object_data_views.admin_add_user, name='admin_add_user'),
    path('object_data/<destination>/<location_id>/add_bug/',
         object_data_views.add_bug, name='add_bug'),
    path('object_data/<destination>/<location_id>/add_customer/',
         object_data_views.add_customer, name='add_customer'),
    path('object_data/<destination>/<location_id>/add_group/',
         object_data_views.add_group, name='add_group'),
    path('object_data/<destination>/<location_id>/add_link/',
         object_data_views.add_link, name='add_link'),
    path('object_data/<destination>/<location_id>/add_notes/',
         object_data_views.add_notes, name='add_notes'),
    path('object_data/<destination>/<location_id>/add_tags/',
         object_data_views.add_tags, name='add_tags'),
    path('object_data/<destination>/<location_id>/add_user/',
         object_data_views.add_user, name='add_user'),
    path('object_data/<destination>/<location_id>/associated_objects/', object_data_views.associated_objects,
         name='associated_objects'),
    path('object_data/bug_client_list/',
         object_data_views.bug_client_list, name='bug_client_list'),
    path('object_data/<destination>/<location_id>/bug_list/',
         object_data_views.bug_list, name='bug_list'),
    ...
    path('object_data/<destination>/<location_id>/group_list/',
         object_data_views.group_list, name='group_list'),
    ...
    path('object_data/<destination>/<location_id>/<object_lookup>/link_list/', object_data_views.link_list,
         name='link_list'),
    path('object_data/<destination>/<location_id>/note_list/',
         object_data_views.note_list, name='note_list'),
    ...
    path('object_data/tag_list_all/',
         object_data_views.tag_list_all, name='tag_list_all'),
    path('object_data/<destination>/<location_id>/user_list/',
    ...
    path('object_data/lead_user_list/',
         object_data_views.lead_user_list, name='lead_user_list'),
    ...
    path('project_information/<int:project_id>/',
         project_views.project_information, name='project_information'),
    ...
    # Request for Change
    path('rfc_deployment/<int:rfc_id>/',
         request_for_change_views.rfc_deployment, name='rfc_deployment'),
    path('rfc_information/<int:rfc_id>/',
         request_for_change_views.rfc_information, name='rfc_information'),
    ...
    path('rfc_information/<int:rfc_id>/save/risk/',
         request_for_change_views.rfc_save_risk, name='rfc_save_risk'),
    path('rfc_information/<int:rfc_id>/save/test/',
         request_for_change_views.rfc_save_test, name='rfc_save_test'),
    path('rfc_information/<int:rfc_id>/update_status/', request_for_change_views.rfc_update_status,
         name='rfc_update_status'),
    path('rfc_readonly/<int:rfc_id>/',
         request_for_change_views.rfc_readonly, name='rfc_readonly'),
    ...
    path('search/group/data/', search_views.search_group_data,
         name='search_group_data'),
    path('search/customer/', search_views.search_customer, name='search_customer'),
    path('search/customer/data/', search_views.search_customer_data,
         name='search_customer_data'),
    path('search/organisation/', search_views.search_organisation,
         name='search_organisation'),
    path('search/organisation/data/', search_views.search_organisation_data,
         name='search_organisation_data'),
    path('search/permission_set/', search_views.search_permission_set,
         name='search_permission_set'),
    path('search/permission_set/data/', search_views.search_permission_set_data,
    ...
    path('search/user/data/', search_views.search_user_data,
    ...
    # Tasks
    path('task_information/<int:task_id>/',
         task_views.task_information, name='task_information'),
    path('task_information/<int:task_id>/save/',
         task_views.task_information_save, name='task_information_save'),

    # Users
    path('user_information/<int:username>/',
         user_views.user_information, name='user_information'),
    path('user_information/<int:username>/save/',
         user_views.user_information_save, name='user_information_save'),
    path('user_information/update_user_password/',
