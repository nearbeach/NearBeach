...
urlpatterns = [
	...
	path('object_data/<destination>/<location_id>/object_link_list/',object_data_views.object_link_list,name='object_link_list'), #WTF - Please check to make sure we need this function?
