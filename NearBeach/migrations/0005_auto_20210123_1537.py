    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blocked_change_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                          related_name='blocked_change_task',
                                                          to='NearBeach.change_task')),
                ('change_task_blocks', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                         related_name='change_task_blocks',
                                                         to='NearBeach.change_task')),
                ('change_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='change_task_block_change_user',
                                                  to=settings.AUTH_USER_MODEL)),
                ('creation_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                    related_name='change_task_block_creation_user',
                                                    to=settings.AUTH_USER_MODEL)),
            ],
            options={
