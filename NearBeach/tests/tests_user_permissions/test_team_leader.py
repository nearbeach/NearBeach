...
class TeamLeaderPermissionTests(TestCase):
    ...
    def test_basic_page_loads_successful(self):
        ...
        data_list = [
            ...
            URLTest(
                "private_download_file",
                ["80a7bd50-eba9-49f8-a55c-d1febd052ab9"],
                {},
                400,
                "GET",
            ),
            ...
            URLTest(
                "my_planner_add_object",
                [],
                {"job_date": "2024-05-14", "destination": "task", "task": 1},
                200,
                "POST",
            ),
            ...
            URLTest(
                "my_planner_update_object_list",
                [],
                {"user_job_id": 1, "job_date": "2024-05-15", "new_destination": 1},
                400,
                "POST",
            ),
            URLTest(
                "my_planner_update_object_list",
                [],
                {"user_job_id": 3, "job_date": "2024-05-15", "new_destination": 3},
                200,
                "POST",
            ),
            ...
            URLTest(
                "gantt_chart_update_data",
                ["project", 1],
                {"end_date": "2024-05-10", "start_date": "2024-05-01", "status_id": 1},
                403,
                "POST",
            ),
            URLTest(
            ...
            URLTest(
                ...
                {
                    "object_note_id": 4,
                    "object_note": "<p>Add note</p>",
                    "date_modified": "2024-09-25T09:15:34.033Z",
                    "username": 7,
                    "first_name": "Dark",
                    "last_name": "Admin",
                    "profile_picture": "",
            ...
            URLTest(
                "schedule_object_information_save",
                [1],
                {
                    "object_type": 1,
    ...
    def test_notification_pages_redirect_to_dashboard(self):
        ...
        data_list = [
            ...
            URLTest(
                "diagnostic_information_upload_test", "/", [], {}, 302, 200, "POST"
            ),
        ]
