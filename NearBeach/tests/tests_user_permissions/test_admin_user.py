    ...
    def test_basic_permissions_as_admin(self):
        ...
        data_list = [
            ...
            URLTest(
                "admin_add_user",
                [],
                {"group": 1, "permission_set": 1, "username": 1},
                200,
                "POST",
            ),
            URLTest(
                "admin_add_user", [], {"group": 1, "permission_set": 1}, 400, "POST"
            ),
            ...
            URLTest(
                "add_link",
                ["project", 1],
                {"project": 2, "object_relation": "blocked_by"},
                200,
                "POST",
            ),
            ...
            URLTest(
                ...
                ["2fc398ee-d12b-4f60-9ecb-40199ac74f13"],
                {},
                400,
                "GET",
            ),
