...
class ApiReadOnlyPermissionTests(BaseApiClass):
    ...
    def test_api_permissions_read_only_project_customers(self):
    ...
    def test_api_permissions_read_only_project_documentation(self):
    ...
    def test_api_permissions_read_only_project_groups(self):
        """Test - API Admin Permissions for the Project Documentation submodule"""
        data_list = [
            #########
            # READ
    ...
    def test_api_permissions_read_only_project_links(self):
        """Test - API Admin Permissions for the Project Documentation submodule"""
        data_list = [
            #########
            # READ
    ...
    def test_api_permissions_read_only_project_misc(self):
    ...
    def test_api_permissions_read_only_project_notes(self):
    ...
    def test_api_permissions_read_only_project_organisation(self):
    ...
    def test_api_permissions_read_only_project_public_link(self):
    ...
    def test_api_permissions_read_only_project_sprint_links(self):
    ...
    def test_api_permissions_read_only_project_user_list(self):
