...
import RfcInformation from "/src/js/components/request_for_change/RfcInformation.vue";
...
describe(' ParentModules.vue - rendering component', () => {
    ...
    const wrapper = mount(RfcInformation, {
        props: {
            groupLeaderCount: 1,
            isReadOnly: true,
            rfcChangeLead: [{"id":1,"email":"support@nearbeach.org","first_name":"Admin","last_name":"User","username":"admin","profile_picture":null}],
