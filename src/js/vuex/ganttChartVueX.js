...
export const moduleGanttChart = {
    ...
    actions: {
        ...
        removeGanttChartSingleRow({ commit, state }, payload) { // Added state parameter
        ...
        updateGanttChartSingleRow({ commit, state }, payload) { // Added state parameter
