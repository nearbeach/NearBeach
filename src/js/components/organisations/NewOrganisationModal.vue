<template>
	<div
		class="modal fade"
		id="newOrganisationModal"
		tabindex="-1"
		aria-labelledby="newOrganisationModalLabel"
		aria-hidden="true"
	>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<button
						...
						aria-label="Close"
						id="newOrganisationModalCloseButton"
					></button>
				</div>
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<p class="text-instructions">
								Please fill out all the required fields. Please
								only use a generic email for the organisation
					...
					>
						...
						<div class="col-md-4">
							...
							<p class="text-instructions">
								The server has found potential duplications.
								Please review the following Organisations. If
								you would like to create the organisation,
								please scroll to the bottom of the page and hit
								"Submit Organisation". If the organisation you
								are looking for is already created. Click on the
								name and you will be taken to the Organisation's
								Information page.
							</p>
							<strong>Alternatively</strong>
							<p class="text-instructions">
								You can also change the information above and
								resubmit.
							</p>
						</div>
			...
			uploadOrganisationData() {
				...
				axios
					...
					.then((response) => {
						...
						this.$emit("created_new_organisation", {
							value: data.pk,
							organisation_email: data.fields.organisation_email,
							organisation_name: data.fields.organisation_name,
							organisation_profile_picture:
								data.fields.organisation_profile_picture,
							organisation_website:
								data.fields.organisation_website,
						});
					})
					.catch((error) => {});
			},
