                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p class="text-instructions">
                                Please fill out all the required fields. Please only use a generic email for the
                                organisation email field. e.g. support@companyxyz.com
                            </p>
                        </div>
                        <div class="col-md-8">
                            <!-- ORGANISATION NAME -->
            ...
            uploadOrganisationData: function () {
                ...
                axios.post(
                    ...
                    this.$emit('created_new_organisation', {
                        ...
                        organisation_profile_picture: data.fields.organisation_profile_picture,
                        organisation_website: data.fields.organisation_website,
                    })
                }).catch(error => {
