<template>
   <div class="modal fade" id="confirmCardArchiveModal" tabindex="-1" aria-labelledby="confirmCardArchiveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h3>Are you sure you want to archive the following card?</h3>
                    <div class="row">
    ...
    export default {
        ...
        methods: {
            archiveCard: function() {
                ...
                //Close the modal
                document.getElementById("confirmCardArchiveModalCloseButton").click();
